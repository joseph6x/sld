...
public class Config {
	...
	public int getJoinWorkerThreads() {
		return Integer.parseInt( props.getProperty("joinWorkerThreads", "10"));
	}
	...
	public int getUnionWorkerThreads() {
		return Integer.parseInt( props.getProperty("unionWorkerThreads", "10"));
	}
	...
	public int getEnforceMaxQueryTime() {
		return Integer.parseInt( props.getProperty("enforceMaxQueryTime", "60"));
	}
